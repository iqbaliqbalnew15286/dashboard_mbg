...
import {
    ...
    XCircle, AlertTriangle, FileSpreadsheet, Download, Upload
} from 'lucide-react';
...
export default function BahanBaku({ bahan_bakus, filters, stats = { total_barang: 0, total_aset: 0 } }) {
    ...
    const handleImportSubmit = (e) => {
        ...
        router.post('/master/bahan-baku/import', formData, {
            onSuccess: () => {
                ...
                <div className="flex flex-wrap gap-2 w-full lg:w-auto bg-white p-2 rounded-2xl shadow-sm border border-slate-100">
                    <div className="relative flex-1 min-w-[180px]">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2.5 bg-slate-50 border-none rounded-xl text-sm font-bold outline-none w-full"
                        />
                    </div>
                    <button
                        type="button"
                        onClick={() => window.location.href = '/master/bahan-baku/export'}
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
                                        <FileSpreadsheet className="text-emerald-600" size={24} /> Import Master Bahan Baku
                                    </h2>
                            ...
                            <form onSubmit={handleImportSubmit} className="space-y-5">
                                <div className="bg-blue-50/60 border border-blue-100 p-4 rounded-2xl flex items-center justify-between">
                                    ...
                                    <a
                                        href="/master/bahan-baku/template"
